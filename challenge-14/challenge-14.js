(function() {
  ...
  */
  console.log( '\nJust Numbers:' );
  // ?
  var justNumbers = numberObjects.map((object) => {
  ...
  */
  ...
  var justMod20r3 = justNumbers.filter((number) => number % 2 === 0 || number % 3 === 0);
  ...
  */
  console.log( '\nOperation:' );
  // ?
  var operation = justMod20r3.reduce( (acumulado, atual) => {
  ...
  */
  console.log( '\nOperation 2:' );
  // ?
  var operation2 = justMod20r3.reduceRight( (acumulado, atual) => {
    return ( acumulado + 1 ) * atual;
  }, 0);
