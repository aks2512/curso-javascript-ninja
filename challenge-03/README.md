...
*/
pessoa.andar = (number_of_meters) => pessoa.caminhouQuantosMetros += number_of_meters;pessoa.andando = true;
...
pessoa.apresentacao = () => {
	...
	let message = 'Olá, eu sou ';
	message = (pessoa.sexo == 'masculino') ? 
		message += 'o ' : 
		message += 'a ';
	...
	message = (pessoa.idade == 1) ? 
		message += ' ano' : message += ' anos';
	
	message += ', ' + pessoa.altura +
		', meu peso é ' + pessoa.peso +
		'e, só hoje, eu já caminhei ' +
		pessoa.caminhouQuantosMetros;

	message = (pessoa.caminhouQuantosMetros == 1) ? 
		message += ' metro!' : message += ' metros!';
...
// Agora, apresente-se ;)
Olá, eu sou o akira fukamizu, tenho 24 anos, 1.8, meu peso é 100e, só hoje, eu já caminhei 10 metros!
```
