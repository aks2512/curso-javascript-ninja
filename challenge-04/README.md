...
console.log(isTruthy("string" === "string"));
...
*/
carro.adicionarPessoas = (numero_de_pessoas) => {
	if( carro.quantidadePessoas + numero_de_pessoas == carro.assentos ) {
		carro.quantidadePessoas += numero_de_pessoas;
		return 'O carro já está lotado!';
	}
	else if ( (carro.assentos > carro.quantidadePessoas) &&
			 (numero_de_pessoas + carro.quantidadePessoas > carro.assentos)) {
...
console.log(carro.quantidadePessoas)ç
<!-- 1 -->
```
